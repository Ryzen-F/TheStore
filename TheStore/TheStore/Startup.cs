...
using TheStore.Models.Handlers;
using System;
...
namespace TheStore
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //{
            //    google.ClientId = Configuration["Authentication:Google:client_id"];
            //    google.ClientSecret = Configuration["Authentication:Google:client_secret"];
            //});
