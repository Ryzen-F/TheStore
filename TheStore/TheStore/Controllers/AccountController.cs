...
using TheStore.Models.ViewModel;
...
namespace TheStore.Controllers
{
    ...
    public class AccountController : Controller
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(user.Email, "Welcome",
                        ...
                        "<h4>The Store is the <i>bestest store</i>!!!</h4>" +
            ...
            if (ModelState.IsValid)
            {
                ...
                {   //send an email welcoming the user back
                    ...
                    await _emailSender.SendEmailAsync(user.Email, "You've logged in",
                        ...
                        "<h2>Our featured product this week is the brand new<font color='red'> iPhone 12.</font></h2>" +
                        "<p>Buy one <b>today</b> and you'll be prepared to travel around in <i>style</i>.</p>");
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel forgotPasswordViewModel)
        {
            ...
            await _emailSender.SendEmailAsync(user.Email, "Reset password", callback);
            return RedirectToAction(nameof(ForgotPasswordConfirmation)); ;
        }
